...
function AddnewProduct({ innerBodyColor, bodyColor}) {
            ...
            <div className="mt-5">
              ...
              <div className="mt-5">
                ...
                <div className="grid grid-cols-2 gap-[15px]">
                  <div className="">
                    <input
                      className={`"" mt-[6px] w-full px-[6px] py-[11px] border-solid outline-none rounded-[10px] placeholder:px-[10px] border border-1px`}
                      type="text"
                      name="vendorName"
