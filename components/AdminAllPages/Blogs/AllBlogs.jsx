...
function AllBlogs({ blogs }) {
  ...
  const totalProducts = blogData.length;
  const productsPerPage = 9;
  const paginatedProducts = blogData.slice(
  ...
  return (
    <div>
      <div className="p-[25px] min-h-[90vh] bg-white ">
        <div className="flex flex-row justify-between">
          <div className="">
            <h1 className="text-[26px] font-[600]">Blog List</h1>
          </div>
          ...
          <div className="grid grid-cols-1 ">
            <div className="col-span-1 overflow-x-scroll">
              <table className="w-[1500px] overflow-x-scroll">
                <thead>
                  <tr>
                    <th className="text-start text-[14px] px-4">Blog</th>
                    <th className="text-start text-[14px] px-4">Blog Id</th>
                    <th className="text-start text-[14px] px-4">Category</th>

                    <th className="text-start text-[14px] px-4">
                      Created Date
                    </th>
                ...
                <tbody>
                  {paginatedProducts.map((product) => (
                    <tr
                      key={product._id}
                      className="hover:bg-[#f1f1f4] cursor-pointer"
                    >
