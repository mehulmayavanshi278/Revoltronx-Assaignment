...
const AllBanner = ({banners}) => {
  ...
  const totalProducts = bannerData?.length;
  ...
  return (
    <div className="bg-white p-4 py-6">
      <div className="flex px-[25px] flex-row justify-between">
        <div> 
          <h1 className="text-[26px] font-[600] ">All Banners</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1">
          <div className="col-span-1 overflow-x-scroll">
            <table className="w-[1200px]">
              <thead>
                <tr>
                  <th className="text-start text-[14px] px-4">Banner</th>
                  <th className="text-start text-[14px] px-4">id</th>
                    ...
                    <td className="py-2 px-4">
                      <div className="flex flex-row justify-start items-center gap-[10px]">
                        ...
                        <div className="mt-0 flex flex-col justify-center">
                          <p className="text-[14px] font-[500]">{`${elm.title}`}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-2 px-4">
